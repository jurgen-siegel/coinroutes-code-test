...
(exports.ActionId = void 0),
  ...
  ((D = exports.ConnectionStatus || (exports.ConnectionStatus = {}))[
    (D.Connected = 1)
  ] = 'Connected'),
  (D[(D.Connecting = 2)] = 'Connecting'),
  (D[(D.Disconnected = 3)] = 'Disconnected'),
  (D[(D.Error = 4)] = 'Error'),
  (function (e) {
    (e[(e.LIMIT = 1)] = 'LIMIT'),
      (e[(e.MARKET = 2)] = 'MARKET'),
  ...
  ((k = exports.OrderType || (exports.OrderType = {}))[(k.Limit = 1)] =
    'Limit'),
  (k[(k.Market = 2)] = 'Market'),
  (k[(k.Stop = 3)] = 'Stop'),
  (k[(k.StopLimit = 4)] = 'StopLimit'),
  (function (e) {
    (e[(e.BUY = 1)] = 'BUY'), (e[(e.SELL = -1)] = 'SELL');
  })(V || (V = {})),
  (exports.Side = void 0),
  ((F = exports.Side || (exports.Side = {}))[(F.Buy = 1)] = 'Buy'),
  (F[(F.Sell = -1)] = 'Sell'),
  (function (e) {
  ...
  ((M = exports.OrderStatus || (exports.OrderStatus = {}))[(M.Canceled = 1)] =
    'Canceled'),
  (M[(M.Filled = 2)] = 'Filled'),
  ...
  ((B = exports.OrderStatusFilter || (exports.OrderStatusFilter = {}))[
    (B.All = 0)
  ] = 'All'),
  ...
  ((H = exports.ParentType || (exports.ParentType = {}))[(H.Order = 1)] =
    'Order'),
  (H[(H.Position = 2)] = 'Position'),
  (H[(H.IndividualPosition = 3)] = 'IndividualPosition'),
  (function (e) {
    (e[(e.StopLoss = 0)] = 'StopLoss'),
  ...
  ((J = exports.NotificationType || (exports.NotificationType = {}))[
    (J.Error = 0)
  ] = 'Error'),
  ...
  (oe.DateOrDateTime = 'dateOrDateTime'),
  (oe.Default = 'default'),
  (oe.Fixed = 'fixed'),
  (oe.FixedInCurrency = 'fixedInCurrency'),
  (oe.VariablePrecision = 'variablePrecision'),
  (oe.FormatQuantity = 'formatQuantity'),
  (oe.FormatPrice = 'formatPrice'),
  (oe.FormatPriceForexSup = 'formatPriceForexSup'),
  (oe.FormatPriceInCurrency = 'formatPriceInCurrency'),
  (oe.IntegerSeparated = 'integerSeparated'),
  (oe.LocalDate = 'localDate'),
  (oe.LocalDateOrDateTime = 'localDateOrDateTime'),
  (oe.Percentage = 'percentage'),
  (oe.Pips = 'pips'),
  (oe.Profit = 'profit'),
  (oe.ProfitInInstrumentCurrency = 'profitInInstrumentCurrency'),
  (oe.Side = 'side'),
  (oe.PositionSide = 'positionSide'),
  (oe.Status = 'status'),
  (oe.Symbol = 'symbol'),
  (oe.Text = 'text'),
  (oe.Type = 'type'),
  (oe.MarginPercent = 'marginPercent'),
  (oe.Empty = 'empty'),
  (exports.OverridePriceAxisLastValueMode = void 0),
  ((re =
    exports.OverridePriceAxisLastValueMode ||
    (exports.OverridePriceAxisLastValueMode = {}))[
    (re.LastPriceAndPercentageValue = 0)
  ] = 'LastPriceAndPercentageValue'),
  (re[(re.LastValueAccordingToScale = 1)] = 'LastValueAccordingToScale'),
  (exports.OverrideLineStyle = void 0),
  ((ne = exports.OverrideLineStyle || (exports.OverrideLineStyle = {}))[
    (ne.Solid = 0)
  ] = 'Solid'),
  (ne[(ne.Dotted = 1)] = 'Dotted'),
  (ne[(ne.Dashed = 2)] = 'Dashed'),
  (function (e) {
  ...
  ((le = exports.ChartStyle || (exports.ChartStyle = {}))[(le.Bar = 0)] =
    'Bar'),
  (le[(le.Candle = 1)] = 'Candle'),
  (le[(le.Line = 2)] = 'Line'),
  (le[(le.Area = 3)] = 'Area'),
  (le[(le.Renko = 4)] = 'Renko'),
  (le[(le.Kagi = 5)] = 'Kagi'),
  ...
  (le[(le.HeikinAshi = 8)] = 'HeikinAshi'),
  (le[(le.HollowCandle = 9)] = 'HollowCandle'),
  (le[(le.Baseline = 10)] = 'Baseline'),
  (le[(le.Range = 11)] = 'Range'),
  (le[(le.HiLo = 12)] = 'HiLo'),
  ...
  ((he = exports.PlDisplay || (exports.PlDisplay = {}))[(he.Money = 0)] =
    'Money'),
  (he[(he.Pips = 1)] = 'Pips'),
  (he[(he.Percentage = 2)] = 'Percentage'),
  (exports.TradedGroupHorizontalAlignment = void 0),
  ((ge =
    exports.TradedGroupHorizontalAlignment ||
    (exports.TradedGroupHorizontalAlignment = {}))[(ge.Left = 0)] = 'Left'),
  (ge[(ge.Center = 1)] = 'Center'),
  (ge[(ge.Right = 2)] = 'Right'),
  ...
  ((me = exports.VisibilityType || (exports.VisibilityType = {})).AlwaysOn =
    'alwaysOn'),
  (me.VisibleOnMouseOver = 'visibleOnMouseOver'),
  (me.AlwaysOff = 'alwaysOff'),
  (exports.PriceScaleMode = void 0),
  ((ye = exports.PriceScaleMode || (exports.PriceScaleMode = {}))[
    (ye.Normal = 0)
  ] = 'Normal'),
  (ye[(ye.Log = 1)] = 'Log'),
  (ye[(ye.Percentage = 2)] = 'Percentage'),
  (ye[(ye.IndexedTo100 = 3)] = 'IndexedTo100'),
  (exports.SeriesType = void 0),
  ((Te = exports.SeriesType || (exports.SeriesType = {}))[(Te.Bars = 0)] =
    'Bars'),
  (Te[(Te.Candles = 1)] = 'Candles'),
  (Te[(Te.Line = 2)] = 'Line'),
  (Te[(Te.Area = 3)] = 'Area'),
  (Te[(Te.HeikenAshi = 8)] = 'HeikenAshi'),
  (Te[(Te.HollowCandles = 9)] = 'HollowCandles'),
  (Te[(Te.Baseline = 10)] = 'Baseline'),
  (Te[(Te.HiLo = 12)] = 'HiLo'),
  (Te[(Te.Column = 13)] = 'Column'),
  (Te[(Te.LineWithMarkers = 14)] = 'LineWithMarkers'),
  (Te[(Te.Stepline = 15)] = 'Stepline'),
  (Te[(Te.HLCArea = 16)] = 'HLCArea'),
  (Te[(Te.VolCandle = 19)] = 'VolCandle'),
  (Te[(Te.HLCBars = 21)] = 'HLCBars'),
  (Te[(Te.Renko = 4)] = 'Renko'),
  (Te[(Te.Kagi = 5)] = 'Kagi'),
  (Te[(Te.PointAndFigure = 6)] = 'PointAndFigure'),
  (Te[(Te.LineBreak = 7)] = 'LineBreak'),
  (function (e) {
    e.Value = '_seriesId';
  })(_e || (_e = {})),
  (function (e) {
  ...
  ((Pe = exports.HHistDirection || (exports.HHistDirection = {})).LeftToRight =
    'left_to_right'),
  (Pe.RightToLeft = 'right_to_left'),
  (function (e) {
  ...
  ((Ae = exports.MarkLocation || (exports.MarkLocation = {})).AboveBar =
    'AboveBar'),
  (Ae.BelowBar = 'BelowBar'),
  (Ae.Top = 'Top'),
  (Ae.Bottom = 'Bottom'),
  (Ae.Right = 'Right'),
  (Ae.Left = 'Left'),
  (Ae.Absolute = 'Absolute'),
  (Ae.AbsoluteUp = 'AbsoluteUp'),
  (Ae.AbsoluteDown = 'AbsoluteDown'),
  (function (e) {
  ...
  ((Ie = exports.LineStyle || (exports.LineStyle = {}))[(Ie.Solid = 0)] =
    'Solid'),
  (Ie[(Ie.Dotted = 1)] = 'Dotted'),
  (Ie[(Ie.Dashed = 2)] = 'Dashed');
const Re = {
    width: 800,
    height: 500,
    interval: '1D',
...
let xe = !1;
function ke() {
  return 'CL v29.4.0 (internal id 29ac1aba6675f14818f3a5a9da75fa91c79107d0 @ 2025-06-25T14:02:27.771Z)';
}
const Ve = class {
  constructor(e) {
    if (
    ...
    'dark' === (this._options.theme ?? 'light').toLowerCase() &&
      ...
      (this._options.debug || this._options.debug_broker) &&
        (xe ||
          ((xe = !0),
          console.log(
            'Using CL v29.4.0 (internal id 29ac1aba6675f14818f3a5a9da75fa91c79107d0 @ 2025-06-25T14:02:27.771Z)'
          ))),
  ...
  applyOverrides(e) {
    (this._options = Oe(this._options, { overrides: e })),
  ...
  _render(e, t, i) {
    ...
    const r = (function (e, t) {
      const i = new URL(`${e || ''}`, location.href).href,
        o = JSON.parse(
          '["bundles/runtime.23405bb06c49e3d455da.js","bundles/__LANG__.2464.fc7f44a5c8b3791719aa.js","bundles/1996.25e6f30e7a095ec239f4.css","bundles/207.dd2de59fb0b299b4eed5.js","bundles/library.6ef314468a2a940f40f4.js"]'
        ),
...
(exports.version = ke), (exports.widget = Ve);
